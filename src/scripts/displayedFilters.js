...
function onClickToIngredient(query) {
  ...
  // on each ingredient into ingredients list
  $ingredientsList.forEach((ingredient, i) => {
    ...
    ingredient.addEventListener("click", (e) => {
      ...
      if (!query.ingredients.includes(target)) {
        ...
        // const $ingredientItemOnDOM = document.querySelector(`#ingredients ul li[data-id="${i}"]`);
        // $ingredientItemOnDOM.style.display = 'none'; // hide the selected ingredient on the DOM
...
function onClickToAppliance(query) {
  ...
  $appliancesList.forEach((appliance) => {
    ...
    appliance.addEventListener("click", (e) => {
      ...
      if (!query.appliances.includes(target)) {
...
function onClickToUstensil(query) {
  ...
  $ustensilsList.forEach((ustensil) => {
    ...
    ustensil.addEventListener("click", (e) => {
      ...
      if (!query.ustensils.includes(target)) {
