  ...
  $ingredientsList.forEach((ingredient, i) => {
    ...
    ingredient.addEventListener("click", (e) => {
      ...
      if (!query.ingredients.includes(target)) {
        ...
        // ingredientsList.splice(i, 1); // remove selected ingredient of ingredients array
  ...
  $ustensilsList.forEach((ustensil) => {
    ustensil.addEventListener("click", (e) => {
      ...
      if (!query.ustensils.includes(target)) {
        ...
        console.log(ustensil, 'e:', e, e.target);
        ustensil.classList.add('toggle-hide-ustensils');
